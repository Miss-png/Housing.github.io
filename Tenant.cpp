...
int main(){
	...
	do
	{
		cout <<"\n\t******************MENU********************";
		cout <<"\n\t*                                        *";
		cout <<"\n\t*      1. Add tenant                     *"; //add tenant
		cout <<"\n\t*      2. New tenant address details     *"; //enter name ,building of tenant, rent
		cout <<"\n\t*      3. Move a tenant                  *";//remove tenant enter name and building
		cout <<"\n\t*      4. Remove tenant                  *";//transfer a tenant to new building
